(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("skrollto", [], factory);
	else if(typeof exports === 'object')
		exports["skrollto"] = factory();
	else
		root["skrollto"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function skrollto() {
	    ...
	    var ease = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : sinOut;
	    ...
	    var time = Math.abs(scrollY - offset) / speed;
	    ...
	    function tick() {
	        ...
	        if (p < 1) {
	            ...
	            callback && (0, _raf2.default)(callback); // eslint-disable-line callback-return
	        }
	    }
